...
ecalBarrelRecHitsValidation.EBdigiCollection = cms.InputTag('mix', 'simEcalUnsuppressedDigis')
ecalEndcapRecHitsValidation.EEdigiCollection = cms.InputTag('mix', 'simEcalUnsuppressedDigis')
