...
sed 's/reco-application-ecal-digitization.root/Photon_E30GeV_all_digis.root/' ${SWSOURCE}/src/Configuration/Applications/data/reco-application-ecal-localreco.cfg >&! ${WORKDIR}/Photon_E30GeV_all_testsuite1.cfg
...
sed 's/EcalRecHitsValidation_old.root/Photon_E30GeV_all_EcalRecHitsValidation_old.root/' ${SWSOURCE}/src/Validation/EcalRecHits/test//EcalRecHitsPlotCompare.C | sed 's/EcalRecHitsValidation_new.root/Photon_E30GeV_all_EcalRecHitsValidation_new.root/' | sed 's/EcalRecHitsPlotCompare/Photon_E30GeV_all_testsuite3/' >&! ${WORKDIR}/Photon_E30GeV_all_testsuite3.C
